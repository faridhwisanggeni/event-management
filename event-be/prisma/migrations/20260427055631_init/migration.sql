-- CreateEnum
CREATE TYPE "attendee_role" AS ENUM ('BACKEND_DEVELOPER', 'FRONTEND_DEVELOPER', 'FULLSTACK_DEVELOPER', 'PROJECT_MANAGER', 'PRODUCT_OWNER', 'CHIEF_TECHNOLOGY_OFFICER', 'HEAD_OF_ENGINEERING', 'ENGINEERING_MANAGER', 'DATABASE_ADMINISTRATOR', 'DEVOPS', 'DEVSECOPS', 'NETWORK_ENGINEERING', 'AI_ENGINEER');
